...
context_input_path = base / "data" / "crsp" / "processed" / "crsp_ftsm_context.parquet"         # "/data/crsp/processed/crsp_ftsm_context.parquet"
validation_input_path = base / "data" / "crsp" / "processed" / "crsp_ftsm_validation.parquet"   # "/data/crsp/processed/crsp_ftsm_validation.parquet"
