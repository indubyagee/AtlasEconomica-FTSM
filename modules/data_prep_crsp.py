...
def main() -> None:
    data_dir = os.path.join(".", "data", "crsp", "raw")
    export_dir = os.path.join(".", "data", "crsp", "processed")
    ...
    train_csv_path  = os.path.join(export_dir, "crsp_ftsm_context.csv")
    train_path      = os.path.join(export_dir, "crsp_ftsm_context.parquet")
    val_csv_path    = os.path.join(export_dir, "crsp_ftsm_validation.csv")
    val_path        = os.path.join(export_dir, "crsp_ftsm_validation.parquet")
    test_csv_path   = os.path.join(export_dir, "crsp_ftsm_test.csv")
    test_path       = os.path.join(export_dir, "crsp_ftsm_test.parquet")
    full_csv_path   = os.path.join(export_dir, "crsp_ftsm_all.csv")
    full_path       = os.path.join(export_dir, "crsp_ftsm_all.parquet")
